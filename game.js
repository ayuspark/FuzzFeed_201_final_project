...
//ASSIGN ANSWERS TO EACH IMG ITEM
...
Images.all[2].question = 'How many kittens are there?';
...
Images.all[6].question = 'How many penguin heads do you see?';
...
Images.all[11].question = 'How many wolves are there?';

Images.all[12].answer = [{n1: 10},{y: 8},{n2: 'The whole horde!'}];
Images.all[12].question = 'How many zombies are about to eat you?';
...
Images.all[15].question = 'Is this a pixar CGI fishy or real fishy?';
...
Images.all[17].question = 'Is this the Moon or a torilla on the window?';
...
Images.all[20].question = 'Is this a messy book shelf or a pile of boxes?';
...
Images.all[23].answer = [{n1: 'Eeyore from Winnie The Pooh!'},{y: 'Stich from Lelo and Stich!'}];
...
Images.all[28].answer = [{y: 'right'},{n1: 'left'}];
Images.all[28].question = 'which one is the stunt double for Drax The Destroyer?';
