...
Images.all[3].answer = [{n1: 2},{n2: 4},{y: 3}];
...
Images.all[12].answer = [{n1: 8},{y: 10},{n2: 'the whole horde!'}];
...
Images.all[20].answer = [{n1: 'popping his head out'},{y: 'flexing his gainzz'}, {n2: 'gathering food!'}];
Images.all[20].question = 'what\'s the squirel doing?';
Images.all[21].answer = [{n1: 'a fence'},{y: 'quokka'}, {n2: 'a brick'}];
Images.all[21].question = 'what adorable animal is this?';
Images.all[22].answer = [{n1: 'yes'},{y: 'no'}];
Images.all[22].question = 'is this eeyore from winnie the pooh?';
Images.all[23].answer = [{n1: 'false'},{y: 'true'}];
Images.all[23].question = 'true or false, this is eeyore showing his tail';
Images.all[24].answer = [{n1: 'right'},{y: 'left'}];
Images.all[24].question = 'which one is real thor?';
Images.all[25].answer = [{n1: 'right'},{y: 'left'}];
Images.all[25].question = 'which one is James Franco?';
Images.all[26].answer = [{n1: 'right, other is wax figure' }, {n2: 'left,other is wax figure'}, {y: 'he is his own double with a wax figure!'}];
Images.all[26].question = 'which one is jackie\'s stunt double?';
Images.all[27].answer = [{n1: 'right'},{y: 'left'}];
Images.all[27].question = 'which one is NOT the stunt double?';
Images.all[28].answer = [{n1: 'the dog! it\'s laying the smackdown!'},{y: 'the cat! it\'s throwing them hands!'}];
Images.all[28].question = 'Who is winning the play fight?';
Images.all[29].answer = [{n1: 'real'},{y: 'pixar'}];
Images.all[29].question = 'real ocean or pixar ocean?';
